...
const auditActionLabels: Record<SupportedLocale, Record<string, string>> = {
  en: {
    ...
    team_invitation_renewed: "Team invitation renewed",
  ...
  ja: {
    ...
    oauth_account_unlinked: "OAuthアカウント連携解除",
    oauth_account_linked: "OAuthアカウント連携",
    oauth_user_created: "OAuthユーザー作成",
    organization_audit_exported: "組織監査エクスポート",
    ...
    team_invitation_renewed: "チーム招待更新",
    team_invitation_revoked: "チーム招待取り消し",
  ...
  ko: {
    ...
    oauth_account_unlinked: "OAuth 계정 연결 해제",
    oauth_account_linked: "OAuth 계정 연결",
    oauth_user_created: "OAuth 사용자 생성",
    organization_audit_exported: "조직 감사 내보내기",
    ...
    team_invitation_renewed: "팀 초대 갱신",
    team_invitation_revoked: "팀 초대 폐기",
